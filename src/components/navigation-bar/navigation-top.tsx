...
function NavigationTop() {
  ...
  return (
    <header className='hidden md:flex items-center justify-between px-4 py-4 border-b border-gray-200 fixed top-0 w-full z-10 bg-white 
    dark:bg-gray-950 dark:text-gray-50 dark:border-gray-800'>
      <DinoLabIcon />
      <nav className='hidden md:flex items-center gap-4 text-sm font-medium'>
    
          <Button className='text-gray-900 hover:underline dark:text-gray-50'>Blog</Button>
